...
router.patch("/user/edit-profile",       protect, allwodTo("USER"),  upload.fields([{ name: "image", maxCount: 1 }]),               UserProfileValidator,       editUserProfile);
router.patch("/restaurant/edit-profile", protect, allwodTo("RESTAURANT"),        upload.fields([{ name: "image", maxCount: 1 }]),    RestaurantProfileValidator, editRestaurantProfile);
