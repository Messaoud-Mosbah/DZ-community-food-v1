...
router.patch("/user/edit-profile",       protect, allwodTo("USER"),                 UserProfileValidator,       editUserProfile);
router.patch("/restaurant/edit-profile", protect, allwodTo("RESTAURANT"),           RestaurantProfileValidator, editRestaurantProfile);
