...
const saveQuestion = asyncHandler(async (req, res, next) => {
    ...
    res.status(201).json({ status: 'SUCCESS', message: 'Question saved to saves questions' });
});
...
const unsaveQuestion = asyncHandler(async (req, res, next) => {
    ...
    res.status(200).json({ status: 'SUCCESS', message: 'Question removed from saves questions' });
});
